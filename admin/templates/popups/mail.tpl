...
<script language="JavaScript">
	...
	function refreshParent()
	{
		...
		var location = 'index.php?page=feedback&id=' + randomnumber + '&act=msg#cont';
...
<script language="javascript" type="text/javascript">
	...
	<body background="images/popup_bg.jpg" LEFTMARGIN=0 RIGHTMARGIN=0 TOPMARGIN=0 MARGINWIDTH=0 MARGINHEIGHT=0 <?php if($done == true) echo ' onLoad="closeMe()" onUnload="refreshParent()"'; ?>>
			...
			<tr bgcolor="#C6E3FF">
				<td colspan="5" valign="middle">
					<table width="100%" height="40">
						<tr>
							<td valign="middle" align="center" width="50"><img src="images/mail.gif"></td>
							<td valign="middle"><span class="head">New Message</span></td>
						</tr>
					</table>
				</td>
			</tr>
		...
		<form name="theform" method="post" action="popup.php?page=mail<?php if(!empty($ContID)) echo '&ContID='.$ContID; ?>">
			...
			<tr>
				<td height="25" valign="middle"><span class="sub">To:</span></td>
